...
import { connectDB } from './modules/database/mongoDB/index.js';
...
import {
    ...
    backupRoutes,
    badwordsRoutes,
    channelContentRoutes,
    dashboardLogRoutes,
    linksRoutes,
    logRoutes,
    membersRoutes,
    protectionRoutes,
    scheduleMessagesRoutes,
    welcomeImageRoutes,
...
app.use('/api/v1/badwords', badwordsRoutes);
app.use('/api/v1/channel-content', channelContentRoutes);
app.use('/api/v1/dashboard-log', dashboardLogRoutes);
app.use('/api/v1/links', linksRoutes);
app.use('/api/v1/log', logRoutes);
app.use('/api/v1/members', membersRoutes);
app.use('/api/v1/protection', protectionRoutes);
app.use('/api/v1/schedule-messages', scheduleMessagesRoutes);
app.use('/api/v1/welcome-image', welcomeImageRoutes);
